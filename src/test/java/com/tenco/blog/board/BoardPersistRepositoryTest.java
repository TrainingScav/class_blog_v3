...
public class BoardPersistRepositoryTest {
    ...
    public void findAll_test() {
        ...
        for (Board board : boardList) {
            ...
            System.out.println(boardList.get(cnt).getId());
            System.out.println(boardList.get(cnt).getTitle());
            System.out.println(boardList.get(cnt).getContent());
            System.out.println(boardList.get(cnt).getUsername());
